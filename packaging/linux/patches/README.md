...
**Program**: windowtolayer — a GPL-3.0 program bundled with the Ray Linux package to
...
`zwlr_layer_surface_v1`, and filters the compositor's `xdg_wm_base` global out entirely. Ray
