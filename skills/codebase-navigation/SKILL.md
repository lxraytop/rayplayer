...
| 首页、网格、集合导航 | `src/components/app/Home.tsx` | `components/app/home/buildHomeModel.ts`、`GridViewOverlayHost.tsx`、`src/Grid3D.tsx`、`src/GridView.tsx`、`src/components/ray-grid/*` |
