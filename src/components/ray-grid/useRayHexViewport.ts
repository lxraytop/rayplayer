...
// Shared React viewport state for Ray's hex-grid card surfaces.
export interface UseRayHexViewportOptions {
    itemCount: number;
    spacingX: number;
    spacingY: number;
    renderRadius: number;
...
export const useRayHexViewport = ({
    itemCount,
    spacingX,
    spacingY,
    renderRadius,
