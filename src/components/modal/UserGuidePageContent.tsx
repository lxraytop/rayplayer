...
import rayIcon from '../../../build/icon.png';
            ...
            <>
                ...
                <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <UserGuideFeatureCard
                        ...
                        description={t('userGuide.clickThrough.trayDesc', 'Right-click the Ray tray icon and choose the click-through option to enable or disable it.')}
                    />
                    <UserGuideFeatureCard
                        {...featureCardClasses}
                        icon={Command}
        ...
        return (
            <>
                <UserGuideTipCard
                    ...
                    description={t('userGuide.theme.desc', 'Customize Ray with your own light and dark color themes, or generate an AI theme from the current song.')}
                />
                <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <UserGuideFeatureCard
                        {...featureCardClasses}
                    ...
                    <UserGuideFeatureCard
                        ...
                        description={t('userGuide.theme.aiDesc', 'When AI theme settings are configured, Ray can create song-aware colors and optionally auto-apply cached song themes.')}
                    />
                </div>
            </>
        );
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[320px] text-center">
            <div className={`w-24 h-24 rounded-3xl ${isDaylight ? 'bg-black/[0.03]' : 'bg-white/5'} border ${isDaylight ? 'border-black/10' : 'border-white/10'} flex items-center justify-center mb-6 shadow-lg`}>
                <img src={rayIcon} alt="Ray" className="w-16 h-16" />
            </div>
            ...
            <p className={`text-sm ${textSecondary} max-w-xs leading-relaxed`}>
                {t('userGuide.ready.subtitle', 'Nikmati perjalanan musik Anda dengan Ray.')}
            </p>
        </div>
    );
};
