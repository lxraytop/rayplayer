...
const DEFAULT_UPDATE_CHANNEL = 'stable' as const;
...
const SettingsModal: React.FC<SettingsModalProps> = ({
    ...
    const handleUpdateChannelChange = async (_channel: 'stable') => {
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            <div>
                                                ...
                                                <p className="text-xs opacity-50 mt-1" style={{ color: 'var(--text-secondary)' }}>
                                                    {activeSettingsSection === 'appearance' && (t('options.visualSettingsPanelDesc') || "Customize the look and feel of Ray.")}
