...
// La Ray's public-domain D-minor theme, transcribed from its 3/4 LilyPond notation.
export const LA_RAY_STAFF_NOTES: readonly SonnetStaffNote[] = [
...
export const LA_RAY_TOTAL_BEATS = LA_RAY_STAFF_NOTES.reduce(
    (total, note) => total + note.beats,
    0,
);

export const LA_RAY_CYCLE_SECONDS = 8;
