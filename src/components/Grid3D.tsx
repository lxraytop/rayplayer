...
import DesktopGrid3DSurface from './ray-grid/DesktopGrid3DSurface';
import {
...
export const Grid3D: React.FC<Grid3DProps> = (props) => {
    ...
    useEffect(() => {
        ...
        window.addEventListener('ray-refresh-favorite-albums', handleRefreshAlbums);
        return () => window.removeEventListener('ray-refresh-favorite-albums', handleRefreshAlbums);
    }, []);
