...
export default function App() {
    ...
    useEffect(() => {
        (window as any).__ray_current_time = currentTime;
    }, [currentTime]);
    ...
    }), [cadenzaTuning, cappellaTuning, classicTuning, claddaghTuning, dioramaTuning, fumeTuning, monetTuning, partitaTuning, pendoloTuning, rippleTuning, sonnetTuning, temperaTuning, tiltTuning]);
    ...
    useEffect(() => {
        ...
        window.addEventListener('ray-themes-synced', handleSyncCompleted);
        return () => window.removeEventListener('ray-themes-synced', handleSyncCompleted);
    ...
    // X11 wallpaper mode cannot use click-through:because it would let clicks raise other background window above Ray. Hide the toggle.
