...
// Converts OpenSubsonic songLyrics v2 cue timing into Ray's native lyric timeline.
...
// Merges the official enhanced response tracks into Ray's single display timeline.
