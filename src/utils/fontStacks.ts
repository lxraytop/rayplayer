...
const TRANSLATION_FONT_STACKS: Record<Theme['fontStyle'], string> = {
    ...
    serif: `${SUGAR_SERIF_FAMILY}, "Ray Noto Serif SC", "Iowan Old Style", Georgia, "Times New Roman", "Noto Serif CJK SC", "Source Han Serif SC", "Songti SC", "STSong", "SimSun", "Noto Serif JP", "Source Han Serif JP", "Yu Mincho", "MS PMincho", serif`,
