...
const OBS_CSS_BACKGROUND_VAR = '--ray-obs-custom-bg';
const OBS_CSS_PORTRAIT_VAR = '--ray-obs-custom-portrait';
const OBS_CSS_CAPPELLA_EMOJIS_VAR = '--ray-obs-cappella-emojis';
const OBS_CSS_CAPPELLA_AVATARS_VAR = '--ray-obs-cappella-avatars';
...
export const buildObsCustomCss = async (): Promise<BuildObsCustomCssResult | null> => {
  ...
  const css = [
    '/* Ray OBS custom assets. Paste into OBS Browser Source -> Custom CSS. */',
