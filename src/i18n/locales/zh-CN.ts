...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "visualizer-ripple": { "title": "切换到可视化：涟漪", "description": "切换到涟漪可视化" },
      "visualizer-sonnet": { "title": "切换到可视化：商籁", "description": "切换到商籁可视化" },
      "visualizer-tempera": { "title": "切换到可视化：凝彩", "description": "切换到凝彩色块 PV 可视化" },
      "view-home-toggle-layout": { "title": "首页：切换卡片 / 列表", "description": "在卡片网格与列表布局之间切换首页曲库" },
      "view-playlist-toggle-layout": { "title": "歌单：切换卡片 / 列表", "description": "在卡片画布与歌曲列表之间切换歌单详情" },
  ...
  "home": {
    ...
    "gridFolderRemoveSelectedDescription": "将从 Ray 及本地歌单中移除 {{count}} 首歌曲，但不会删除磁盘文件。",
    "gridFolderRemoveRootTitle": "移除导入根目录？",
    "gridFolderRemoveRootDescription": "从 Ray 移除 {{path}} 及其中全部歌曲？不会删除磁盘文件。",
    "login": "登录",
    "welcomeBack": "欢迎回来",
  ...
  "options": {
    ...
    "languageSettings": "语言",
    "appLanguage": "界面语言",
    "appLanguageDesc": "手动指定 Ray 的界面语言",
    ...
    "nativeBlurConfirmDesc": "开启后，窗口会变为系统毛玻璃效果的半透明背景，Ray 的各种背景将不再显示。如果系统不支持，则会显示为白色不透明背景。",
    ...
    "discordRichPresenceDesc": "在 Discord 桌面端展示 Ray 当前播放歌曲。",
    ...
    "rippleSettings": "涟漪参数",
    "rippleSettingsDesc": "调整歌词落水的字号、速度、水波与水花强度，以及各水层的显示。",
    "rippleSectionTypography": "排版",
    "rippleSectionMotion": "动效",
    "rippleSectionWater": "水面",
    "rippleSectionLayers": "图层显示",
    "rippleFontScale": "歌词字号",
    "rippleAnimationSpeed": "动画速度",
    "rippleDropHeight": "落水高度",
    "rippleRippleStrength": "涟漪强度",
    "rippleSplashStrength": "水花强度",
    "rippleAmbientStrength": "环境波纹",
    "rippleWaterDistortion": "水波扭曲",
    "rippleReflectionStrength": "倒影强度",
    "rippleAudioReactivity": "音频响应",
    "rippleShowWaterSurface": "水面光效",
    "rippleShowReflection": "水面倒影",
    "rippleShowImpact": "落水波纹",
    "rippleShowSplash": "飞溅水花",
    "rippleShowAmbient": "环境涟漪",
    "rippleToggleOn": "开启",
    "rippleToggleOff": "关闭",
    ...
    "importExportDesc": "通过标准 JSON 或 ray-theme 文本导入/导出配色主题与歌词动画设置。",
    ...
    "obsThemeModeBuiltinHint": "OBS 按封面从 Ray 内置库逐曲挑最合适的配色。",
  ...
  "unifiedPanel": {
    "nowPlayingStageDescription": "Now Playing 正由外部播放器控制，Ray 只负责展示歌词和视觉效果。",
    "stageLocalInputDescription": "Stage 现在是本地单项输入模式。外部可以推送一份完整歌词对象或一段媒体，播放与展示仍由 Ray 自己控制。",
  },
  "artistGrid": {
  ...
  "userGuide": {
    ...
    "theme": {
      ...
      "aiDesc": "配置 AI 主题设置后，Ray 可以根据歌曲生成配色，并可自动应用已缓存的歌曲主题。"
    },
    "clickThrough": {
      "title": "点击穿透恢复",
      "desc": "开启点击穿透后，如果窗口控件被隐藏或不方便触达，可以通过系统托盘图标切换点击穿透。",
      "trayTitle": "使用托盘图标",
      "trayDesc": "右键点击 Ray 的系统托盘图标，在菜单中选择点击穿透选项，即可开启或关闭。",
      "lockTitle": "使用锁定按钮",
  ...
  "aiHelp": {
    "openButton": "遇到问题？",
    "title": "遇到问题？",
    "description": "建议先查阅 Ray 文档。如果问题仍未解决，再复制下方提示词询问 AI。",
    "docsTitle": "先查看 Ray 文档",
    "docsDescription": "查看使用说明、功能配置和常见问题排查指南。",
    "openDocs": "打开文档",
    "askAiTitle": "仍未解决？询问 AI",
    "askAiDescription": "先描述你的具体问题，再粘贴这段提示词，让 AI 结合 Ray 文档和源码协助排查。",
