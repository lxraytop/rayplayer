...
export default {
  "notifications": {
    ...
    "rippleReset": "Ripple tuning reset",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "visualizer-ripple": { "title": "Visualizer: Ripple", "description": "Switch to the Ripple visualizer" },
      ...
      "view-home-toggle-layout": { "title": "Home: switch cards / list", "description": "Toggle the home library between the card grid and the list layout" },
      "view-playlist-toggle-layout": { "title": "Playlist: switch cards / list", "description": "Toggle the playlist detail between the card canvas and the track list" },
  ...
  "home": {
    ...
    "gridFolderRemoveSelectedDescription": "This removes {{count}} tracks from Ray and its playlists. Files on disk will not be deleted.",
    "gridFolderRemoveRootTitle": "Remove imported root?",
    "gridFolderRemoveRootDescription": "Remove {{path}} and all its tracks from Ray? Files on disk will not be deleted.",
    "login": "Login",
  ...
  "options": {
    ...
    "appLanguageDesc": "Manually set Ray's interface language, or switch back to following the system.",
    ...
    "transparentPlayerBackgroundDesc": "Only applies on the player page. When enabled, Ray switches to transparent window mode for OBS browser sources or chroma key overlays.",
    ...
    "nativeBlurConfirmDesc": "This changes the window to a translucent background using the system glass effect. Ray backgrounds will not be shown.",
    ...
    "discordRichPresenceDesc": "Show the current Ray track in Discord desktop. Ray connects with its built-in application identity.",
    ...
    "rippleSettingsDesc": "Tune the lyric font size, speed, water and splash strength, and which water layers are drawn.",
    "rippleSectionTypography": "Typography",
    "rippleSectionMotion": "Motion",
    "rippleSectionWater": "Water",
    "rippleSectionLayers": "Visible layers",
    "rippleFontScale": "Lyric size",
    "rippleAnimationSpeed": "Animation speed",
    "rippleDropHeight": "Drop height",
    "rippleRippleStrength": "Ripple strength",
    "rippleSplashStrength": "Splash strength",
    "rippleAmbientStrength": "Ambient waves",
    "rippleWaterDistortion": "Water distortion",
    "rippleReflectionStrength": "Reflection strength",
    "rippleAudioReactivity": "Audio reactivity",
    "rippleShowWaterSurface": "Surface light",
    "rippleShowReflection": "Reflection",
    "rippleShowImpact": "Impact ripple",
    "rippleShowSplash": "Splash droplets",
    "rippleShowAmbient": "Ambient rings",
    "rippleToggleOn": "On",
    "rippleToggleOff": "Off",
    ...
    "importExportDesc": "Import or export custom themes and visual settings using standard JSON or Ray-specific shortcodes.",
  ...
  "releaseNotes": {
    "v1_5_0": {
      "intro": "Here are the new features and improvements in version 1.5.0.",
  ...
  "localMusic": {
    ...
    "playlistImportNoMatches": "No playlist paths matched the local songs currently imported into Ray.",
  ...
  "unifiedPanel": {
    "nowPlayingStageDescription": "Now Playing is being controlled by an external player. Ray is only responsible for displaying lyrics and visual effects.",
    "stageLocalInputDescription": "Stage is in local single-input mode. External devices can push lyrics or media, but playback and display are controlled by Ray itself.",
  },
  "artistGrid": {
  ...
  "obs": {
    "connecting": "Connecting to Ray",
    "waitingForPlayback": "Waiting for Ray playback"
  },
  "queue": {
  ...
  "userGuide": {
    ...
    "theme": {
      "title": "Color themes",
      "desc": "Customize Ray with your own light and dark color themes, or generate an AI theme from the current song.",
      "customDesc": "Open Theme Park from visual settings or the command palette to edit and save custom light and dark colors.",
      "aiDesc": "When AI theme settings are configured, Ray can create song-aware colors and optionally auto-apply cached song themes."
    },
    "clickThrough": {
      ...
      "trayDesc": "Right-click the Ray system tray icon, then choose the click-through option to turn it on or off.",
    ...
    "ready": {
      "title": "Ready to Go",
      "subtitle": "Enjoy your music journey with Ray."
    }
  },
  "remote": {
  ...
  "aiHelp": {
    ...
    "title": "Need help?",
    "description": "Check the Ray documentation first. If the issue remains unresolved, copy the prompt below and ask an AI model for help.",
    "docsTitle": "Read the Ray documentation",
    ...
    "askAiDescription": "Describe your issue, then paste this prompt so the AI can use Ray documentation and source code as context.",
