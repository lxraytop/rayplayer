export default {
  ...
  "options": {
    ...
    "enableAutoUpdateDesc": "Unduh pembaruan otomatis setelah versi baru ditemukan.",
      ...
      "updateChannelDesc": "Hanya rilis stabil yang didukung.",
  ...
  "unifiedPanel": {
    "nowPlayingStageDescription": "Now Playing sedang dikendalikan oleh pemutar eksternal. Ray hanya bertanggung jawab menampilkan lirik dan efek visual.",
    "stageLocalInputDescription": "Stage dalam mode input tunggal lokal. Perangkat eksternal dapat mengirim lirik atau media, tetapi pemutaran dan tampilan dikendalikan oleh Ray sendiri.",
  },
  "artistGrid": {
  ...
  "userGuide": {
    ...
    "theme": {
      "title": "Tema warna",
      "desc": "Sesuaikan Ray dengan tema warna terang dan gelap Anda sendiri, atau buat tema AI dari lagu saat ini.",
      ...
      "aiDesc": "Saat pengaturan tema AI dikonfigurasi, Ray bisa membuat warna yang sesuai lagu dan opsional menerapkan tema lagu yang di-cache secara otomatis."
    },
    "clickThrough": {
    ...
    "ready": {
      ...
      "subtitle": "Nikmati perjalanan musik Anda dengan Ray."
    }
  },
  "remote": {
...
,
  ...
  "aiHelp": {
    ...
    "title": "Butuh bantuan?",
    "description": "Periksa dokumentasi Ray terlebih dahulu. Jika masalah belum teratasi, salin prompt di bawah dan mintalah bantuan model AI.",
