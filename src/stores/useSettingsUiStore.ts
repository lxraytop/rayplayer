...
export const CACHE_SIZE_KEY = 'ray_cache_size';
const ENABLE_MEDIA_CACHE_KEY = 'ray_enable_media_cache';
const LAST_SEEN_GUIDE_VERSION_STORAGE_KEY = 'ray_last_seen_guide_version';
