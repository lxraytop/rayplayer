...
const SYNC_CONFIG_STORAGE_KEY = 'ray_sync_config_v1';
const SYNC_STATUS_STORAGE_KEY = 'ray_sync_status_v1';
const SYNC_CONFIG_EVENT = 'ray-sync-config-changed';
const SYNC_STATUS_EVENT = 'ray-sync-status-changed';
