...
RUN npm ci --omit=dev
COPY deploy/docker/scripts/patch-music-api-client-ip.mjs /usr/local/lib/ray/patch-music-api-client-ip.mjs
RUN node /usr/local/lib/ray/patch-music-api-client-ip.mjs netease
