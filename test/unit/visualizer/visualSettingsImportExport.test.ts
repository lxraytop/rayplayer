...
describe('Visual Settings Import and Export', () => {
    ...
    it('correctly compresses a full config to a base64 theme code starting with ray-theme://', () => {
        const code = compressConfig(sampleConfig);
        expect(code.startsWith('ray-theme://')).toBe(true);
    ...
    it('gracefully throws error on invalid configuration input strings', () => {
        ...
        expect(() => decompressConfig('ray-theme://invalidbase64@@')).toThrow();
