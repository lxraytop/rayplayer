        ...
        <article class="stage-result-card" data-song-id="${song.songId}">
            <div class="doc-head">
                ...
                <div class="button-row">
                    <button type="button" class="secondary" data-play-song="${song.songId}">Play In Ray</button>
...
const renderLiveExamples = () => {
    ...
    renderExample(sessionExampleMultipart, () => {
        ...
        formData.set('title', normalizeText(titleInput.value) || 'Ray Demo Tone');
        formData.set('artist', normalizeText(artistInput.value) || 'Ray');
