...
## Bili Live Song Demo
您可以在 `test/manual/bili-livesong/main.py` 中找到一个使用 Stage 搜索和点播接口的[示例程序](https://github.com/角完/ray-player/tree/main/test/manual/bili-livesong)，展示了如何监听 B 站直播间的弹幕，并将符合条件的点歌请求发送到本地播放器接口。
