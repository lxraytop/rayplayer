...
// 粘贴到 Ray 的 devtools 窗口的 console 里面，然后点击 本地 -> All songs，在 v0.5.22版本之前应该可以触发黑屏崩溃
// https://github.com/Akarin520/ray-player/issues/125
...
(async () => {
  ...
  db.close();
  window.dispatchEvent(new CustomEvent('ray-local-music-updated'));
