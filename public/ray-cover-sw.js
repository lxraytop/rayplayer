...
const getCoverResponse = async (requestUrl) => {
  ...
  try {
    ...
    const rayRoot = await root.getDirectoryHandle('ray-cache');
    const directory = await rayRoot.getDirectoryHandle('local-cover-assets');
