...
const DB_PATH = process.env.DB_PATH || path.resolve(__dirname, '../ray-sync.db');
...
console.log(logo);
console.log(`\x1b[32m[Ray Sync Server]\x1b[0m Starting Node.js standalone server (v${version})...`);
